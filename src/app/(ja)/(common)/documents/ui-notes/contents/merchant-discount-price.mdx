...
![](/documents/ui-notes/merchant/discount-price/accessibility-tree--chrome.png)

Google Chromeは「ラーメン」の部分を`deletion`ロールとして解釈している。

![](/documents/ui-notes/merchant/discount-price/accessibility-tree--fx.png)
...
![](/documents/ui-notes/merchant/discount-price/amazon.jpg)
...
![](/documents/ui-notes/merchant/discount-price/rakuten.jpg)

![](/documents/ui-notes/merchant/discount-price/rakuten-02.jpg)

最終的な金額のみの表示か、「商品価格＋送料−獲得予定ポイント」の表で価格が掲載されている。
セール価格の場合も同様で、通常価格や参考価格が書かれるパターンは見当たらなかった。

![](/documents/ui-notes/merchant/discount-price/rakuten-03.jpg)
...
![](/documents/ui-notes/merchant/discount-price/yahoo.jpg)

商品一覧画面では通常価格は書かれておらず、セール表示のみ。

![](/documents/ui-notes/merchant/discount-price/yahoo-02.jpg)
...
![](/documents/ui-notes/merchant/discount-price/zozo.jpg)

商品一覧画面では通常価格は書かれておらず、セール表示のみ。

![](/documents/ui-notes/merchant/discount-price/zozo-02.jpg)
