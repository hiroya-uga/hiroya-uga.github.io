...
<ExampleBox>
  <p>
    ...
    <strong className="text-red-600">
      <span className="mb-1 block text-xs leading-tight text-red-600">セール価格（税込）：</span>
      <span className="mr-2 block text-4xl leading-none font-bold">¥1,980</span>
    </strong>
  </p>
</ExampleBox>
...
<ExampleBox className="mt-4">
  <p>
    ...
    <strong>
      ...
      <span className="mr-2 text-3xl leading-none font-bold text-red-600">¥1,980</span>
    </strong>
  </p>
</ExampleBox>
