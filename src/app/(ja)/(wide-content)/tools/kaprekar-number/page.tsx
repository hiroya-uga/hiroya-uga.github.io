      ...
      <div className="mt-22">
        <NoteBox type="note" title="カプレカ数の例">
          <table className={styles.table}>
            <tbody>
              <tr>
                <th scope="row">3桁のカプレカ数</th>
                <td>495</td>
                <td>1個</td>
              </tr>
              <tr>
                <th scope="row">4桁のカプレカ数</th>
                <td>6174</td>
                <td>1個</td>
              </tr>
              <tr>
                <th scope="row">5桁のカプレカ数</th>
                <td>null</td>
                <td>0個</td>
              </tr>
              <tr>
                <th scope="row">6桁のカプレカ数</th>
                <td>549945、631764</td>
                <td>2個</td>
              </tr>
              <tr>
                <th scope="row">7桁のカプレカ数</th>
                <td>null</td>
                <td>0個</td>
              </tr>
              <tr>
                <th scope="row">8桁のカプレカ数</th>
                <td>97508421</td>
                <td>1個</td>
              </tr>
              <tr>
