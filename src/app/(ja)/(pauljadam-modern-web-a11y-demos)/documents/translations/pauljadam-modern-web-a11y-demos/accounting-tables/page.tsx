import '@/app/(ja)/(pauljadam-modern-web-a11y-demos)/documents/translations/pauljadam-modern-web-a11y-demos/accounting-tables/page.css';

import { getMetadata } from '@/utils/seo';

export const metadata = getMetadata({
  title: "会計テーブル - PaulJAdam's Modern Web Accessibility Demos",
