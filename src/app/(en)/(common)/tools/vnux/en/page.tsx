...
export const metadata = getMetadata('/tools/vnux/en');
...
export default function Page() {
  return (
    <>
      <JsonLd data={jsonLd} />
      <ToolsVnuxPage pageTitle={metadata.pageTitle} following={metadata.following} lang="en" />
    </>
  );
}
