...
<tr>
  <th>Applies to:</th>
  <td>block containers [\[CSS2\]](https://drafts.csswg.org/css-overflow/#biblio-css2), flex containers [\[CSS3-FLEXBOX\]](https://drafts.csswg.org/css-overflow/#biblio-css3-flexbox), and grid containers [\[CSS3-GRID-LAYOUT\]](https://drafts.csswg.org/css-overflow/#biblio-css3-grid-layout)</td>
</tr>
...
<dd>The user agent monitors elements with `observe-type` of `view-*` to see if they intersect on the vertical direction.</dd>

<dt>
  <dfn>horizontal</dfn>
</dt>
<dd>The user agent monitors elements with `observe-type` of `view-*` to see if they intersect on the horizontal direction.</dd>
