...
export const ClearButton = ({ size = 'medium', children = 'クリア', onClick }: Props) => {
  return (
    <button
      type="button"
      className={clsx([
        'rounded-full border border-black bg-[#f1f1f1] text-[#333] transition-[background-color,border-color,box-shadow] hover:border-[#777] hover:bg-white hover:shadow-lg active:border-[#555] active:bg-[#e1e1e1] active:shadow-none disabled:opacity-50',
